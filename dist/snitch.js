...
/***/ function(module, exports, __webpack_require__) {
	...
	function buster() {
	  var seed = ('' + Number(new Date())).substr(-3);
	  var cacheBuster = Number(seed);
	...
	function toQueryString(paramsObject) {
	  var keyValStrings = Object.keys(paramsObject).reduce(function (strs, key) {
	    var keyValStr = encodeURIComponent(key) + '=' + encodeURIComponent(paramsObject[key]);
	...
	exports.default = {
	  ...
	  listenForErrors: function listenForErrors(onErrorThrown, opts) {
	    ...
	    var handler = function reportError(err) {
	      var error = err || {};
	      if (!options.takeScreenshot || !_html2canvas.html2canvas) {
	        onErrorThrown(buildErrorLog(error));
	        return;
	      }
	      (0, _html2canvas.html2canvas)(document.body).then(function (canvas) {
	  ...
	  logUserEvents: function logUserEvents(pixelPath, opts) {
	    ...
	    var recordEvent = function logEvent(e, props) {
	      var event = e || {};
